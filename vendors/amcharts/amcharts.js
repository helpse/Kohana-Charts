...
this.prefixesOfSmallNumbers=[{number:1e-24,prefix:"y"},{number:1e-21,prefix:"z"},{number:1e-18,prefix:"a"},{number:1e-15,prefix:"f"},{number:1e-12,prefix:"p"},{number:1e-9,prefix:"n"},{number:0.000001,prefix:"?ј"},{number:0.001,prefix:"m"}];
...
AmCharts.shortMonthNames=["Ян","Фев","Март","Апр","Май","Июнь","Июль","Авг","Сент","Окт","Ноя","Дек"];
...
return a},destroy:function(){AmCharts.removeSet(this.set)
...
this.groupPercent=0;this.groupedTitle="Другие";
